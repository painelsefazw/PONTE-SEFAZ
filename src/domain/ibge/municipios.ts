 ...
 * do proprio codigo em vez de repetida 5571 vezes.
 */

/** Codigo de UF do IBGE (2 digitos) para sigla. */
export const UF_POR_CODIGO: Readonly<Record<string, string>> = {
  '11': "RO",
  '12': "AC",
  '13': "AM",
  '14': "RR",
...
export const TABELA_MUNICIPIOS = `1100015 Alta Floresta D'Oeste
1100023 Ariquemes
1100031 Cabixi
1100049 Cacoal
1100056 Cerejeiras
