...
import { logoDaMarca, manifest, marca, mensagemDeLogin, rodape, tituloDaPagina } from "@/lib/manifest";
          ...
          >
            <div className="space-y-2">
              ...
              <Input
                ...
                // O usuario e `admin`, salvo se APP_USER trocar. Placeholder com
                // o valor real evita a duvida de quem abre o console pela
                // primeira vez e nao sabe o que digitar.
                placeholder="admin"
                required
              />
            </div>
